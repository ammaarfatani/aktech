          ...
          <div className="relative z-20 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-4 px-6 sm:px-10 pt-8 sm:pt-12 pb-12 sm:pb-16 items-center mt-10">
            ...
            <div className="flex flex-col items-start">
              ...
              >
                ...
                <Link
                  href="#"
                  className="group flex items-center gap-3 px-7 py-3.5 rounded-full text-sm font-semibold tracking-wide transition-all duration-300"
                  style={{
                    background: "linear-gradient(135deg, #3B82F6, #2563EB)",
                    color: "#FFFFFF",
                    boxShadow: "0 0 30px rgba(59,130,246,0.25), 0 4px 15px rgba(59,130,246,0.2)",
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.boxShadow = "0 0 40px rgba(59,130,246,0.35), 0 4px 20px rgba(59,130,246,0.3)";
                    e.currentTarget.style.transform = "translateY(-2px)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.boxShadow = "0 0 30px rgba(59,130,246,0.25), 0 4px 15px rgba(59,130,246,0.2)";
